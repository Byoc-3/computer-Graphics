...
int main(int argc, char* argv[]) {
    ...
    SDL_Texture* img1 = IMG_LoadTexture(renderer, "img1.png");
    SDL_Texture* img2 = IMG_LoadTexture(renderer, "img2.png");
    SDL_Texture* img3 = IMG_LoadTexture(renderer, "img3.png");
    SDL_Texture* img4 = IMG_LoadTexture(renderer, "img4.png");
